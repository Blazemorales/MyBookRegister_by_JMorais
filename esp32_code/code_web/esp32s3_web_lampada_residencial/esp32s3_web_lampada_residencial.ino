 ...
 * Rede residencial (WPA2-Personal / SSID + senha)
 * ============================================================================
 * Idêntico ao esp32s3_web_lampada.ino (variante UnB), trocando apenas a
 * autenticação: WPA2-Enterprise (PEAP/MSCHAPv2, matrícula) vira WPA2-Personal
 * (SSID + senha), como qualquer roteador doméstico.
 */
...
// ============================================================================
//  CONFIGURAÇÃO REDE RESIDENCIAL (WPA2-Personal)
//  WIFI_SSID e WIFI_PASSWORD vêm de credenciais.h (não versionado).
// ============================================================================
...
// ============================================================================
//  WI-FI RESIDENCIAL (WPA2-Personal)
// ============================================================================
void conectarWiFi() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    Serial.printf("[WiFi] Falha ao conectar em \"%s\".\n", WIFI_SSID);
  }
}
...
void setup() {
  ...
  Serial.println("\n=== Servidor Web - Lampada DC 12V (rede residencial) ===");
