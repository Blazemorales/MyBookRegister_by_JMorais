...
const char* EAP_IDENTITY = "241011161@aluno.unb.br";  // identidade
const char* EAP_USERNAME = "241011161@aluno.unb.br";  // usuário (igual à identidade na maioria dos eduroam)
const char* EAP_PASSWORD = "Moao@21_";
